"""Text-to-mesh module backed by a ShapE-family pipeline."""
...
class TextToMesh:
    """Wraps ``diffusers.ShapEPipeline``.

    Returns a :class:`trimesh.Trimesh` ready to be exported as ``.obj``/``.glb``.
    """
    ...
    def generate(
        ...
        *,
        ...
        result = pipe(
            ...
            guidance_scale=guidance if guidance is not None else self.config.mesh_guidance,
